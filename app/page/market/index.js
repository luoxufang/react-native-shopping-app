...
//加载网络数据
  ...
  // _fetchGoodsByCategory(category_id: number){
  //   var thiz = this;
  ...
  // _selectCategory (rowID: number, cate_id: number){
  ...
  // _renderGoodsList(rowData: Object, sectionID: number | string, rowID: number | string){
  //   return (
  //     <View>
